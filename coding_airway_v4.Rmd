...
### Import filtered/refined rds files
```{r Import}
...
saline2
saline2@commands # This will display all manipulations to the object
saline2@meta.data # This will display all categorical data in our object
...
# Assume 'seurat_object' is your Seurat object and cell types are stored in 'Idents(seurat_object)'
...
# Create the dot plot with the reordered y-axis
setwd('/Users/alexanderfoote/dev/Projs/R/Upper_Airway_Coding_Project/plots')
...
#Basal-ventral-trachea vs Basal-dorsal-trachea
fwrite(x = Basal_ventral_dorsal_trachea.marker.de, row.names = TRUE, file = "Basal_ventral_dorsal_trachea.marker.de.csv")

## Overexpressed terms and Volcano plots
###Basal larynx vs trachea
setwd('/Users/alexanderfoote/dev/Projs/R/Upper_Airway_Coding_Project/plots')
name <- "basal.trachea.larynx.barplot.de"
...
###Basal larynx vs myo
setwd('/Users/alexanderfoote/dev/Projs/R/Upper_Airway_Coding_Project/plots')
name <- "basal.larynx.myo.barplot.de"
...
setwd('/Users/alexanderfoote/dev/Projs/R/Upper_Airway_Coding_Project/plots')
name <- "basal.trachea.myo.barplot.de"
...
#print
setwd('/Users/alexanderfoote/dev/Projs/R/Upper_Airway_Coding_Project/plots')
name <- "basal.trachea.myo.volcano.de"
pdf(paste(name,"_VolcanoPlot.pdf",sep=""),width=10,height=15)
EnhancedVolcano(basal.trachea.myo.de, rownames(basal.trachea.myo.de),
                x ="avg_log2FC", y ="p_val_adj", title = 'Basal : Myoepithelial vs Trachea',
...
```{r Basal-ventral-trachea vs Basal-dorsal-trachea}
setwd('/Users/alexanderfoote/dev/Projs/R/Upper_Airway_Coding_Project/plots')
name <- "Basal-ventral-trachea.vs.Basal-dorsal-trachea.barplot.de"
DEenrichRPlot(scRNA_epi_saline, ident.1 = "Club1",  ident.2 = "Club2", balanced = FALSE, logfc.threshold = log(2.5), assay = NULL, max.genes = 100, test.use = "wilcox", p.val.cutoff = 0.05, cols = NULL, enrich.database = "GO_Biological_Process_2023", num.pathway = 20, return.gene.list = F)
DEenrichRPlot(scRNA_epi_saline, ident.1 = "Club1",  ident.2 = "Club2", balanced = FALSE, logfc.threshold = log(2.5), assay = NULL, max.genes = 100, test.use = "wilcox", p.val.cutoff = 0.05, cols = NULL, enrich.database = "KEGG_2021_Human", num.pathway = 25, return.gene.list = F)

EnhancedVolcano(Club1.marker.de, rownames(Club1.marker.de), 
                x ="avg_log2FC", y ="p_val_adj", title = 'Basal-ventral-trachea.vs.Basal-dorsal-trachea',
                FCcutoff = 1.32, pCutoff = 0.01, pointSize = 3.0, labSize = 5.0, legendLabSize = 12, legendIconSize = 4.0, drawConnectors = TRUE, widthConnectors = 0.25)
#print
setwd('/Users/alexanderfoote/dev/Projs/R/Upper_Airway_Coding_Project/plots')
name <- "club1.club2.de"
pdf(paste(name,"_VolcanoPlot.pdf",sep=""),width=10,height=12)
EnhancedVolcano(Club1.marker.de, rownames(Club1.marker.de), 
                x ="avg_log2FC", y ="p_val_adj", title = 'Basal-ventral-trachea.vs.Basal-dorsal-trachea',
                 #selectLab = c('Dcpp3','Lipf','Apoe',"Dcn","Slc22a4","Ica1","Cyb561d1","Slc2a13","Arnt","Gatad2b","Nexmif","Cpm","Eva1a","Git2","Scel","Prkd1","Mical2","Crtc3","Capn13","Kctd8","Spopl","Pcsk7","Mbp","Shb"),
                FCcutoff = 1.32, pCutoff = 0.01, pointSize = 1.0, labSize = 6.0, legendLabSize = 14, legendIconSize = 4.0, drawConnectors = TRUE, widthConnectors = 0.25,  boxedLabels = TRUE,  legendPosition = 'bottom', colAlpha = 4/5)
dev.off()
```
